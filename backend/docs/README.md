...
2. Receive a selection of status changes where the `currentState` equals the `topic`, as the `updatePoints` handler does. This option is the preferred one, when you know ahead of time, what types of events, you want to listen to.
